...
export function SettingsPanel() {
  ...
  const [ocrMode, setOcrMode] = useState<"cloud" | "server">(() => {
    if (typeof window === "undefined") return "cloud";
    return (localStorage.getItem("ocr_mode") as "cloud" | "server") || "cloud";
  });
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex gap-2">
              ...
              >
                服务器 OCR
                <Badge variant="secondary" className="ml-1 text-[9px] px-1 py-0">待开发</Badge>
              </Button>
            </div>
            {ocrMode === "cloud" && (
